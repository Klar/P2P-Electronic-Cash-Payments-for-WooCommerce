...
Donation address:
Tags: bitcoin sv, bitcoin sv wordpress plugin, bitcoin sv plugin, bitcoin sv payments, accept bitcoin sv, bsv, woocommerce
...
Bitcoin SV (BSV) Payment Gateways for Woocommerce. 0 fees, 0 commissions, no third parties, financial sovereignty.
Using Electrum SV Master Public Keys. No Private Keys are stored on your server, and your funds are always safe.
...
* Zero fees and no commissions for bitcoin sv payments processing from any third party.
* Accept payment directly into your personal Electron SV wallet.
* No middleman for payments.
* Accept payment in bitcoin sv for physical and digital downloadable products.
* Individual configurations for each gateway, allowing you to customize each one according to  market conditions.
* Automatic conversion to bitcoin sv via real time exchange rate feed and calculations.
* Ability to set exchange rate calculation multiplier to compensate for any possible losses due to bank conversions and funds transfer fees.
* Ability to set the amount of time for which to cache the exchange rate, allowing you to react faster to market volatility.
...
1. Settings
![Settings](assets/screenshot-1.png?raw=true)
2. Advanced Settings
![Advanced Settings](assets/screenshot-2.png?raw=true)
3. Woocommerce Payment methods
![Woocommerce Payment methods](assets/screenshot-3.png?raw=true)
5. Woocommerce Payments methods Bitcoin SV Settings
![Woocommerce Payments methods Bitcoin SV Settings](assets/screenshot-4.png?raw=true)
...
**Are my keys kept on my server?**
>No! No Private keys are ever stored on your server, the plugin does not need to know about them. So if you do ever get hacked there are no keys to steal, your cryptocurrency is safe. The plugin makes use of HD Master Public Key.


**Does this use any payment processor?**
> No! This uses your electrum/electron Master Public Keys, the crytocurrency goes straight from your customer's wallet to your wallet.

**Are there any fees?**
>No! This is P2P Electron Cash Payments, from your customer to you, with no middle man, no fees are ever taken at any point, nor will they ever be.

**Can I contribute?**
>Sure! Go ahead and make a pull request. Clearly explain what the change does, what's the intended result and why it's required and if it changes any existing behaviour.
